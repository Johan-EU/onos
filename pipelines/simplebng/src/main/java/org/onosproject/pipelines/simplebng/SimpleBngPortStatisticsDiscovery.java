...
import static org.onosproject.pipelines.simplebng.SimpleBngConstants.CNT_EGRESS_PORT_COUNTER_ID;
import static org.onosproject.pipelines.simplebng.SimpleBngConstants.CNT_INGRESS_PORT_COUNTER_ID;


/**
 * Implementation of the PortStatisticsBehaviour for simplebng.p4.
 */
public class SimpleBngPortStatisticsDiscovery extends AbstractHandlerBehaviour implements PortStatisticsDiscovery {
