...
/**
 * Component that when loaded produces and registers the pipeconfs that are available in the application archive.
 */
...
public final class PipeconfLoader {
    ...
    private static PiPipeconf buildTofinoPipeconf(String profile, String platform)
        ...
        return basePipeconfBuilder(profile, platform, p4InfoUrl)
                .addExtension(PiPipeconf.ExtensionType.TOFINO_BIN, tofinoBinUrl)
                .addExtension(PiPipeconf.ExtensionType.TOFINO_CONTEXT_JSON, contextJsonUrl)
                .build();
    }
    ...
    private static DefaultPiPipeconf.Builder basePipeconfBuilder(
        ...
        return DefaultPiPipeconf.builder()
                ...
                .addBehaviour(PiPipelineInterpreter.class, SimpleBngInterpreter.class)
                .addBehaviour(Pipeliner.class, DefaultSingleTablePipeline.class)
                .addBehaviour(PortStatisticsDiscovery.class, SimpleBngPortStatisticsDiscovery.class)
